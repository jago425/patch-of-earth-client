...
var createNewPlant = function createNewPlant(data) {
  return $.ajax({
...
var getPlants = function getPlants() {
  return $.ajax({
    url: config.apiOrigin + '/plants',
    method: 'GET',
    headers: {
...
var showPlant = function showPlant(plantId) {
  return $.ajax({
...
var updatePlant = function updatePlant(plantId, data) {
  return $.ajax({
    url: config.apiOrigin + '/plants/' + plantId,
    method: 'PATCH',
    headers: {
...
var plantEvents = __webpack_require__(18);
...
var signInSuccess = function signInSuccess(response, event) {
...
var newPlant = function newPlant(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createNewPlant(data).then(ui.createPlantSuccess).then(getPlants).catch(ui.createPlantFailure);
};

var getPlants = function getPlants() {
  api.getPlants().then(ui.getAllPlantsSuccess).catch(ui.getAllPlantsFailure);
};

var getAllPlants = function getAllPlants() {
  event.preventDefault();
  getPlants();
};

var onLaunchEditModal = function onLaunchEditModal(event) {
  event.preventDefault();
  $('.modal-message').text('');
  api.showPlant(event.target.dataset.id).then(ui.showPlantSuccess).catch(ui.showPlantFailure);
};

var onSubmitUpdatePlant = function onSubmitUpdatePlant(event) {
  event.preventDefault();
  var data = getFormFields(this);
  var id = data.plant.id;
  api.updatePlant(id, data).then(ui.updatePlantSuccess).catch(ui.updatePlantFailure);
};

var onLaunchDeleteModal = function onLaunchDeleteModal(event) {
  event.preventDefault();
  var plantId = event.target.dataset.id;
  $('#confirm-delete').attr('data-id', plantId);
};

var onDeletePlant = function onDeletePlant(event) {
  event.preventDefault();
  var deleteTarget = event.target.dataset.id;
  api.deletePlant(deleteTarget).then(ui.deletePlantSuccess).catch(ui.deletePlantFailure);
};

var resetFormOnCancel = function resetFormOnCancel(event) {
  $('.plant-input').val('');
};

var plantHandlers = function plantHandlers() {
...
module.exports = {
  ...
  onLaunchEditModal: onLaunchEditModal,
  onSubmitUpdatePlant: onSubmitUpdatePlant,
...
var indexPlantsTemplate = __webpack_require__(20);
var showEditPlantsTemplate = __webpack_require__(37);
var api = __webpack_require__(7);

var createPlantSuccess = function createPlantSuccess() {
...
var createPlantFailure = function createPlantFailure() {
  $('#status-message').text("something's not right");
  clearStatus();
};

var getAllPlantsSuccess = function getAllPlantsSuccess(data) {
  if (data.plants.length > 0) {
    $('#plant-table-data').empty();
    var indexPlants = indexPlantsTemplate({ plants: data.plants });
...
var getAllPlantsFailure = function getAllPlantsFailure() {
  $('#status-message').text('failed to load your plants');
  clearStatus();
};

var showPlantSuccess = function showPlantSuccess(data) {
  ...
  var availableOptions = ['Flower', 'Shrub', 'Fruit', 'Vegetable', 'Tree', 'Succulent', 'Vine', 'Other'];
  ...
  availableOptions.forEach(function (plant_type) {
    var selected = plant_type === data.plant.plant_type ? 'selected' : '';
...
var updatePlantSuccess = function updatePlantSuccess() {
  $('#editPlantModal').modal('toggle');
  $('#status-message').text('Your plant has been updated!');
  api.getPlants().then(getAllPlantsSuccess).catch(getAllPlantsFailure);
  clearStatus();
};

var updatePlantFailure = function updatePlantFailure() {
  $('#status-message').text("something's not right");
  clearStatus();
};

var deletePlantSuccess = function deletePlantSuccess() {
...
module.exports = {
  ...
  getAllPlantsSuccess: getAllPlantsSuccess,
  getAllPlantsFailure: getAllPlantsFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n      <td class='add-table'>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.plant_type : stack1), depth0))
    + "</td>\n      <td class='add-table'>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.common_name : stack1), depth0))
    + "</td>\n      <td class='add-table'>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.scientific_name : stack1), depth0))
    + "</td>\n      <td class='add-table'>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.variety : stack1), depth0))
    + "</td>\n      <td class='add-table'>"
    ...
    + "\" type=\"button\" class=\"btn btn-primary edit-button\" data-toggle=\"modal\" data-target=\"#editPlantModal\">Edit</button>\n        </td>\n        <td class='button-cell'>\n          <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"  type=\"button\" class=\"btn btn-info table-button delete-modal-button\" data-toggle=\"modal\" data-target=\"#delete-plant-modal\">Delete</button>\n        </td>\n    </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<table class=\"table table-responsive table-striped table-bordered\">\n  <thead class='table-header'>\n      <th class='add-table'>Plant Type</th>\n      <th class='add-table'>Common Name</th>\n      <th class='add-table'>Scientific Name</th>\n      <th class='add-table'>Variety</th>\n      <th class='add-table'>Brand</th>\n      <th class='add-table'></th>\n      <th class='add-table'></th>\n  </thead>\n  <tbody>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.plants : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </table>\n  </tbody>\n</table>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <option value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1["0"] : stack1), depth0))
    + "\" "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1["1"] : stack1), depth0))
    + ">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1["0"] : stack1), depth0))
    + "</option>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<form id=\"edit-plant-modal\" class=\"editplant\">\n  <input type=\"hidden\" id='\"plant-id-from-edit-modal\"' name=\"plant[id]\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.plant : depth0)) != null ? stack1.id : stack1), depth0))
    + "'>\n  <label>Plant Type</label>\n  <select class=\"plant-input\" id=\"modal-plant-type\" name=\"plant[plant_type]\" val='select a type'>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.option : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </select>\n<br>\n<label>Common Name:</label><input required class=\"plant-input\" type=\"text\" name=\"plant[common_name]\" required size= \"75\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.plant : depth0)) != null ? stack1.common_name : stack1), depth0))
    + "'><br>\n<label>Scientific Name:</label><input class=\"plant-input\" type=\"text\" name=\"plant[scientific_name]\" size= \"75\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.plant : depth0)) != null ? stack1.scientific_name : stack1), depth0))
    + "' placeholder=\"Scientific Name (optional)\"><br>\n<label>Variety:</label><input class=\"plant-input\" type=\"text\" name=\"plant[variety]\" size= \"75\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.plant : depth0)) != null ? stack1.variety : stack1), depth0))
    + "' placeholder=\"Variety (optional)\"><br>\n<label>Brand:</label><input class=\"plant-input\" type=\"text\" name=\"plant[brand]\" size= \"75\" value='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.plant : depth0)) != null ? stack1.brand : stack1), depth0))
    + "' placeholder=\"Brand (optional)\"><br>\n<br>\n  <button type=\"button\" class=\"btn btn-info\" data-dismiss=\"modal\">Cancel</button>\n  <input type=\"submit\" value=\"Save Changes\" id=\"edit-plant-modal-save\" class=\"btn btn-primary\">\n</form>\n";
},"useData":true,"useBlockParams":true});
